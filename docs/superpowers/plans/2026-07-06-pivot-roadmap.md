...
| PV-6 | Extended calibration — **DONE**. PV-6a (#134): deterministic gate-power characterization (`regress/power_test.go` + `docs/reviews/2026-07-08-gate-power-calibration.md`). PV-6b: live 2-basket validation on real `claude -p` (`docs/reviews/2026-07-08-pv6b-live-calibration.md`) | Synthetic floors + live validation both shipped; defaults re-confirmed (no threshold change); zero false positives on A-vs-A controls |
