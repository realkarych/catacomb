...
- **Always execute implementation plans subagent-driven, never inline** — dispatch a fresh subagent per task with review between tasks; the main window only orchestrates. Do not batch-execute plan tasks directly in the orchestrating session.
